...
Start the Mac peripheral first. Tap **Scan**, select `MacBLE-Demo`, and the app auto-enables Notify, Pair code `135790`, and `getInfo` capability discovery. Use **Pair**, **Ping**, **Info**, **Echo**, **Telemetry**, **Command**, the event-rule segmented control, **Raw**, **Read**, and **Notify On/Off** to compare protocol and legacy BLE behavior.
